...
export function ClockCircleIcon(props) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
...
export function InfoAlertCircleIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="none"
...
export function MenuLinesIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="none"
...
export function FolderListIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="none"
...
export function ChatKeyIcon(props) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        >
            <path
                d="M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m4 4V7"
                strokeLinecap="round"
                strokeLinejoin="round"
            />
        </svg>
...
export function SettingsGearIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="currentColor"
...
export function InputArrowIcon(props) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
...
export function OutputArrowIcon(props) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
...
export function TotalPieIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="currentColor"
...
export function ExportDataIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="currentColor"
...
export function ImportDataIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="currentColor"
...
export function OptimizeSparkleIcon(props) {
    return (
        <svg
            viewBox="0 -960 960 960"
            fill="currentColor"
