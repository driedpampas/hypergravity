...
export function Sidebar() {
  ...
  return (
    <div id="hg-hypergravity-section" className="hypergravity-sidebar-container">
      ...
      <div className="hg-section-content" style={{ maxHeight: isExpanded ? '200px' : '0', overflow: 'hidden', transition: 'max-height 0.2s ease' }}>
        <div className="hg-dropdown-menu">
            
          <div className="hg-dropdown-item" onClick={() => setActiveMenu('folders')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="hg-dropdown-icon">
              <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>
            </svg>
            <span>Folders</span>
          </div>

          <div className="hg-dropdown-item" onClick={() => setActiveMenu('settings')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="hg-dropdown-icon">
